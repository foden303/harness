...
Harness targets Claude Code only. `skills/` is the single source of truth for
skill behavior; mirrors are read-only distribution copies and must never be
edited directly.
