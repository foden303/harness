...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/foden303/harness/main/scripts/quick-install.sh | bash
#
# Or with dev tools:
#   curl -fsSL https://raw.githubusercontent.com/foden303/harness/main/scripts/quick-install.sh | bash -s -- --with-dev-tools
#
# Japanese setup templates:
#   curl -fsSL https://raw.githubusercontent.com/foden303/harness/main/scripts/quick-install.sh | bash -s -- --locale ja
#
...
claude /plugin marketplace add foden303/harness 2>/dev/null || true

# Install
echo "  Installing plugin..."
claude /plugin install harness@harness-marketplace 2>/dev/null || {
...
echo "  ${YELLOW}i18n.language: ja${NC} in .harness.config.yaml"
...
echo "Documentation: https://github.com/foden303/harness"
echo
