...
# Valid state list (kept in sync with States in docs/SESSION_ORCHESTRATION.md)
...
# Get the retry backoff seconds (per SESSION_ORCHESTRATION.md)
get_retry_backoff() {
  local retry_num="${1:-1}"
...
PY
  ...
  # Get the backoff seconds as an array
