...
#
# Checks:
# 1. Whether *.template files under templates/ are registered in the registry
# 2. Whether files in the registry exist under templates/
...
# 1. Check whether files under templates/ are registered in the registry
echo ""
...
# 2. Check whether files in the registry exist under templates/
echo ""
