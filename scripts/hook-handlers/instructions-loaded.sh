...
#
# Purpose:
# - Records the instructions-load event before the session starts
# - Lightly verifies the assumptions of the rules/hook environment
#
# Input: stdin JSON
...
# Lightweight precondition check (does not block even if missing)
