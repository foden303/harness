...
func TestNotificationHandler_TypeFallback(t *testing.T) {
	...
	// Use the type field instead of notification_type
...
func TestNotificationHandler_NoOutput(t *testing.T) {
	...
	// The Notification hook outputs nothing to stdout
	if buf.Len() != 0 {
...
func TestNotificationHandler_LogRotation(t *testing.T) {
	...
	// Create 510 dummy log lines (exceeding the 500-line rotation threshold)
	...
	// After rotation, at most 401 lines (400 + 1 new)
	if len(lines) > 401 {
