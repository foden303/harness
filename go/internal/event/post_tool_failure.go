...
// Reset when more than StalenessThreshold seconds have elapsed since the last failure.
...
type PostToolFailureHandler struct {
	...
	StateDir string
	// nowFunc is a time-injection function for tests. When nil, time.Now() is used.
	nowFunc func() time.Time
}

// postToolFailureInput is the stdin JSON of the PostToolUseFailure hook.
