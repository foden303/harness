...
author = "Foden"
homepage = "https://github.com/foden303/harness"
...
func TestParse_Full(t *testing.T) {
	...
	// [project]
	if cfg.Project.Name != "harness" {
		t.Errorf("project.name = %q, want %q", cfg.Project.Name, "harness")
	}
	...
	if cfg.Project.Author != "Foden" {
		t.Errorf("project.author = %q, want %q", cfg.Project.Author, "Foden")
	}
	if cfg.Project.Homepage != "https://github.com/foden303/harness" {
