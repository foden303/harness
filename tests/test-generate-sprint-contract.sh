...
|------|------|-----|---------|--------|
| 32.1.1 | create the contract | put runtime validation into the contract | 32.0.1 | cc:TODO |
| 32.2.2 | add a browser evaluator | verify the UI flow in the browser | 32.2.1 | cc:TODO |
| 32.2.5 | handle browser_mode: exploratory | prefer AgentBrowser in exploratory mode | 32.2.2 | cc:TODO |
| 43.1.1 | [needs-spike] security migration contract | verify the guard for state migration <!-- advisor:required --> | - | cc:TODO |
EOF
...
| Task | Description | DoD | Depends | Status |
|------|------|-----|---------|--------|
| 41.3.1 | design-heavy task | polish the UI layout with attention to design, styling, and aesthetic | 41.2.1 | cc:TODO |
EOF
