...
| 29.1.2 | build issue payload dry-run | tasks can be extracted from Plans.md | 29.1.1 | cc:TODO |

## Phase 29.3: lightweight brief and machine-readable manifest

| Task | Content | DoD | Depends | Status |
|------|---------|-----|---------|--------|
| 29.3.1 | attach a design brief | a UI brief template exists | - | cc:TODO |
EOF
...
grep -q "29.1.2 build issue payload dry-run" "${MARKDOWN_OUTPUT}"
