...
# Verify plugin.json stays stable across 3 consecutive runs of harness sync
#
...
# Two more consecutive syncs — idempotency verification
...
# Confirm checksums match (idempotent across N runs)
...
# Confirm absence of fields outside the official SSOT
