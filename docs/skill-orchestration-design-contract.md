...
The goal is compatibility across two surfaces:
...
Claude Code skill loaders understand a small set of operational
...
distinguish it from shipped plugin surfaces.
